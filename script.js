function createUser() {
    ...
    if (password == confirm){
        ...
        document.getElementById('accounts-window').style.display = "none";
    ...
    var myWindowFade = document.getElementById('start-window-fade'),
        ...
        function startMenu() {
            if (document.getElementById('settings-window-fade').style.opacity >= 1) {
                fadeOutByMe(document.getElementById('settings-window-fade'));
                fadeOutByMe(document.getElementById('settings-window'));
            }
        ...
        function settings() {
              if (document.getElementById('settings-window-fade').style.opacity <= .1) {
                fadeInByMe(document.getElementById('settings-window-fade'));
                fadeInByMe(document.getElementById('settings-window'));
            } else if (document.getElementById('settings-window-fade').style.opacity >= 1) {
                fadeOutByMe(document.getElementById('settings-window-fade'));
                fadeOutByMe(document.getElementById('settings-window'));
            }
            
            if (document.getElementById('start-window-fade').style.display = 'block') {
                document.getElementById('start-window-fade').style.display = 'none'
                document.getElementById('start-window').style.display = 'none'
            } 
        }
        
        function accounts() {
           if (document.getElementById('success-window').style.display = "none"){
           var accounts = document.getElementById('accounts-window');
